...
\input{Sections/7_SystemDesign/7_1_1_5_DAC_AMP.tex}
...
\input{Sections/7_SystemDesign/7_3_MainProcessor.tex}
\input{Sections/7_SystemDesign/7_3_4_DataStructure.tex}
\input{Sections/7_SystemDesign/7_3_1_MCUSCCommunication.tex}
\input{Sections/7_SystemDesign/7_3_2_SpectralAnalysis.tex}
\input{Sections/7_SystemDesign/7_3_3_5_OpenShort.tex}
\input{Sections/7_SystemDesign/7_3_3_MainProcessorConclusion.tex}

%Implemented Design
\input{Sections/11_Implementation/7_1_7_PCBDesign.tex}

%System verification 
\input{Sections/8_SystemVerification/8_SystemVerification.tex}
\input{Sections/8_SystemVerification/8_1_ReviewOfRequirement.tex}
\input{Sections/8_SystemVerification/8_1_Accuracy.tex}
%\input{Sections/8_SystemVerification/8_2_PriceAnalysis.tex} -- Moved to Appendix
\input{Sections/8_SystemVerification/8_3_Conclusion.tex}

%Discussion and conclusion
\input{Sections/9_Discussion/9_Discussion.tex}
\input{Sections/10_Conclusion/10_Conclusion.tex}
...
\input{Appendix/DAC_PASSIVE_FILTER.tex}
...
\input{Appendix/A_Schematics.tex}
\input{Appendix/A_PowerConsumption.tex}
\input{Appendix/A_CostAnalysis.tex}
\input{Appendix/A_SystemAccuracyTest.tex}
\input{Appendix/A_MainprocessorCode.tex}
