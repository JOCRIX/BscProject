...
\begin{table}[H]
    ...
    \hline
      ...
      §14 & Binning & Can do component binning$^7$ \\ \hline
    ...
    \caption*{
      ...
      $\mathbf{^8}$ Capable of measuring and saving multiple component values, such that a histogram of the components can be shown. See section \ref{sec:5_2_Histogram}.\\
    }
