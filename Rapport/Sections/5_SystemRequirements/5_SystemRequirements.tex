...
requiremets are based upon these.

The requirements for modulus and argument accuracy are based on the R\&S LCX-200, given that the scope of this project however is to
research and develop a frequency analyser at a lower price point, the specifications are looser than that of the LCX-200.
...
their ideal opperating point, often around \SIQ{1}{\kilo\hertz} and \SIQ{1}{\kilo\ohm}. The specification given here is based upon this
