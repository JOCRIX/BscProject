...
The requirement of both impedance magnitude and phase accuracy, or modulus and argument accuracy, will be described in more detail
...
principle and as a result it is given as a continuous two-variable function, both for modulus and argument.
...
The function for modulus accuracy can be seen as two plots in figure \ref{fig_5_ModulusAccuracy}. Here the left plot is with a fixed impedance of \SIQ{1}{\kilo\ohm}
