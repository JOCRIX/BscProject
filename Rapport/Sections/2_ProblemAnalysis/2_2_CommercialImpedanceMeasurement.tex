...
\begin{table}[H]
  ...
  \hline
    ...
    Price point               & <1000€   & 5000€ $\mathbf{^8}$   & Undisclosed                                    \\ \hline
  \end{tabular}
  \caption*{
    \raggedright
