...
Impedance analyzers can characterize passive components in order to find the values of capacitance, inductance, quality factor and many other parameters of interest as will be shown later in sections \refq{sec:ImpedanceAnalysis}, \refq{subsec:Reactance} and \refq{subsec:LossTangent}. The impedance of a DUT must be measured and analyzed in order to quantify these other DUT parameters that are used when designing circuits.
