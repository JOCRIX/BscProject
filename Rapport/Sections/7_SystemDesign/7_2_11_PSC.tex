...
\end{figure}
The wait for clocks is a simple counter, an example can be seen in listing \ref{lst:7_2_11_PSC_COUNTER}. Here it can be seen that in state S4, the FSM will not advance to state S5 before 10 clocks have occured, each clock takes \SIQ{5}{\nano\second} with a \SIQ{200}{\mega\hertz} master clock, resulting in a delay of \SIQ{50}{\nano\second}.
