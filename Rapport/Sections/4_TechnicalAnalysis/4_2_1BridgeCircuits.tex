...
The Wheatstone bridge has been around since the 18-hundreds, and was among the very first methods used to characterize an unknown impedance. Originally only used for DC resistance measurements, but with a few modifications it was expanded to characterize impedances as well. 
...
shown that the unknown impedance $Z_1$ and its phase angle can be found from the 3 other known impedances and phase angles, as shown
