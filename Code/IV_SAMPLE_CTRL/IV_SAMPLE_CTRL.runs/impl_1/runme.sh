...
HD_PWD='C:/Users/jakob/Desktop/P7---Bsc/Code/IV_SAMPLE_CTRL/IV_SAMPLE_CTRL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IV_SAMPLE_CTRL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IV_SAMPLE_CTRL.tcl -notrace
