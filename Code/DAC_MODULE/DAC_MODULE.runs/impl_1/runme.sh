...
HD_PWD='C:/Users/jakob/Desktop/P7---Bsc/Code/DAC_MODULE/DAC_MODULE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_MODULE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DAC_MODULE.tcl -notrace
