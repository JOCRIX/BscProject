...
HD_PWD='C:/Users/jakob/Desktop/P7---Bsc/Code/DAC_MODULE/DAC_MODULE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_MODULE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_MODULE.tcl
