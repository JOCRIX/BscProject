...
HD_PWD='C:/Users/jakob/Desktop/P7---Bsc/Code/VHDL/EXT_MEM_RW20/EXT_MEM_RW20.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ExternalMemDist20.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ExternalMemDist20.tcl
