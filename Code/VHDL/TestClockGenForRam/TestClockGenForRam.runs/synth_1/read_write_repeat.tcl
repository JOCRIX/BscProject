...
namespace eval ::optrace {
  variable script "C:/EIT GIT/P7---Bsc/Code/VHDL/TestClockGenForRam/TestClockGenForRam.runs/synth_1/read_write_repeat.tcl"
...
read_vhdl -library xil_defaultlib {{C:/EIT GIT/P7---Bsc/Code/VHDL/TestClockGenForRam/TestClockGenForRam.srcs/sources_1/new/read_write_repeat.vhd}}
...
synth_design -top read_write_repeat -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef read_write_repeat.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file read_write_repeat_utilization_synth.rpt -pb read_write_repeat_utilization_synth.pb"  } 
