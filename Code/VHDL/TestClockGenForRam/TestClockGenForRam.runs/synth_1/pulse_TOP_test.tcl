...
namespace eval ::optrace {
  variable script "C:/EIT GIT/P7---Bsc/Code/VHDL/TestClockGenForRam/TestClockGenForRam.runs/synth_1/pulse_TOP_test.tcl"
...
read_vhdl -library xil_defaultlib {
  {C:/EIT GIT/P7---Bsc/Code/VHDL/TestClockGenForRam/TestClockGenForRam.srcs/sources_1/new/pulse_train_gen.vhd}
  {C:/EIT GIT/P7---Bsc/Code/VHDL/TestClockGenForRam/TestClockGenForRam.srcs/sources_1/new/pulse_TOP_test.vhd}
}
...
synth_design -top pulse_TOP_test -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef pulse_TOP_test.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file pulse_TOP_test_utilization_synth.rpt -pb pulse_TOP_test_utilization_synth.pb"  } 
