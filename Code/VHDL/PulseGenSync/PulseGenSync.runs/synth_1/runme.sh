...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/PulseGenSync/PulseGenSync.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse_gen_synchronized.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pulse_gen_synchronized.tcl
