...
set_property IOSTANDARD LVCMOS33 [get_ports i_MASTER_CLK_200MEG_IN]
...
set_property DRIVE 16 [get_ports o_ACTIVE]
set_property DRIVE 16 [get_ports o_PULSE]

set_property OFFCHIP_TERM NONE [get_ports o_ACTIVE]
