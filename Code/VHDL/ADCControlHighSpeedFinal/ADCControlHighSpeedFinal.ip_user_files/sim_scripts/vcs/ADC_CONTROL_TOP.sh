...
#
# Script generated by Vivado on Thu Nov 14 00:45:40 +0100 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ADC_CONTROL_TOP.sh
...
#
# Usage        : ADC_CONTROL_TOP.sh
#                ADC_CONTROL_TOP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ADC_CONTROL_TOP.sh [-reset_run]
#                ADC_CONTROL_TOP.sh [-reset_log]
#                ADC_CONTROL_TOP.sh [-help]
#
...
#                script (type 'ADC_CONTROL_TOP.sh -help' for more information).
#
...
# script info
echo -e "ADC_CONTROL_TOP.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ADC_CONTROL_TOP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ADCControlHighSpeedFinal.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ADC_CONTROL_TOP xil_defaultlib.glbl -o ADC_CONTROL_TOP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ADC_CONTROL_TOP_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ADC_CONTROL_TOP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ADC_CONTROL_TOP_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ADC_CONTROL_TOP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ADC_CONTROL_TOP.sh [-help]\n\
Usage: ADC_CONTROL_TOP.sh [-step]\n\
Usage: ADC_CONTROL_TOP.sh [-lib_map_path]\n\
Usage: ADC_CONTROL_TOP.sh [-reset_run]\n\
Usage: ADC_CONTROL_TOP.sh [-reset_log]\n\
Usage: ADC_CONTROL_TOP.sh [-keep_index]\n\
Usage: ADC_CONTROL_TOP.sh [-noclean_files]\n\n\
