...
#set_property IOSTANDARD LVCMOS25 [get_ports Pulse_complete]
#set_property IOSTANDARD LVCMOS25 [get_ports Pulse_out]
#set_property IOSTANDARD LVCMOS25 [get_ports Trig_in]
#set_property PACKAGE_PIN A16 [get_ports Trig_in]

#set_property OFFCHIP_TERM NONE [get_ports SCK_OUT]
