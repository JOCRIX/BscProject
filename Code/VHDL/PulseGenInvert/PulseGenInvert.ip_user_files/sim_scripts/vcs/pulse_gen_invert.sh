...
#
# Script generated by Vivado on Fri Nov 01 16:25:20 +0100 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pulse_gen_invert.sh
...
#
# Usage        : pulse_gen_invert.sh
#                pulse_gen_invert.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pulse_gen_invert.sh [-reset_run]
#                pulse_gen_invert.sh [-reset_log]
#                pulse_gen_invert.sh [-help]
#
...
#                script (type 'pulse_gen_invert.sh -help' for more information).
#
...
# script info
echo -e "pulse_gen_invert.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pulse_gen_invert.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../PulseGenInvert.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pulse_gen_invert xil_defaultlib.glbl -o pulse_gen_invert_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pulse_gen_invert_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pulse_gen_invert_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pulse_gen_invert_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pulse_gen_invert.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pulse_gen_invert.sh [-help]\n\
Usage: pulse_gen_invert.sh [-step]\n\
Usage: pulse_gen_invert.sh [-lib_map_path]\n\
Usage: pulse_gen_invert.sh [-reset_run]\n\
Usage: pulse_gen_invert.sh [-reset_log]\n\
Usage: pulse_gen_invert.sh [-keep_index]\n\
Usage: pulse_gen_invert.sh [-noclean_files]\n\n\
