...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../PulseGenInvert.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.pulse_gen_invert xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.pulse_gen_invert -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log pulse_gen_invert_sc.so .tmp_log xcelium_lib waves.shm c.obj)
