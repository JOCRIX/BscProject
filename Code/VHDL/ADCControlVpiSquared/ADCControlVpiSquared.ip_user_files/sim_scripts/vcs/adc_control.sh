...
#                script (type 'adc_control.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.adc_control -o adc_control_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./adc_control_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key adc_control_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc adc_control_simv.daidir vcs_lib c.obj)
