...
#
# Script generated by Vivado on Mon Nov 04 02:26:02 +0100 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : adc_control.sh
...
#
# Usage        : adc_control.sh
#                adc_control.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                adc_control.sh [-reset_run]
#                adc_control.sh [-reset_log]
#                adc_control.sh [-help]
#
...
# script info
echo -e "adc_control.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./adc_control.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip --snapshot adc_control xil_defaultlib.adc_control -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim adc_control -key {Behavioral:sim_1:Functional:adc_control} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb adc_control.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./adc_control.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: adc_control.sh [-help]\n\
Usage: adc_control.sh [-step]\n\
Usage: adc_control.sh [-lib_map_path]\n\
Usage: adc_control.sh [-reset_run]\n\
Usage: adc_control.sh [-reset_log]\n\
Usage: adc_control.sh [-keep_index]\n\
Usage: adc_control.sh [-noclean_files]\n\n\
