...
HD_PWD='C:/EIT GIT/P7---Bsc/Code/VHDL/Test/Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wrapper.tcl
