...
HD_PWD='C:/EIT GIT/P7---Bsc/Code/VHDL/Test/Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_wrapper.tcl -notrace
