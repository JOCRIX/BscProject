...
HD_PWD='C:/EIT GIT/P7---Bsc/Code/VHDL/Test/Test.runs/clk_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_clk_wiz_0_0.tcl
