...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/PulseWidthGen/PulseWidthGen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse_wdith_gen_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pulse_wdith_gen_TOP.tcl
