...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/PulseWidthGen/PulseWidthGen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse_wdith_gen_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pulse_wdith_gen_TOP.tcl -notrace
