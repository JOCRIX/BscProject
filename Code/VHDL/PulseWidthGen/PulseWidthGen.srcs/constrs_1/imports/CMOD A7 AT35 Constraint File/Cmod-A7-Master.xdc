...
set_property OFFCHIP_TERM NONE [get_ports E_PULSE_OUT]
set_property OFFCHIP_TERM NONE [get_ports E_TRIGGER_OUT]
set_property IOSTANDARD LVCMOS33 [get_ports E_MASTER_CLK]
set_property IOSTANDARD LVCMOS33 [get_ports E_PULSE_OUT]
set_property IOSTANDARD LVCMOS33 [get_ports E_TRIGGER_IN]
set_property IOSTANDARD LVCMOS33 [get_ports E_TRIGGER_OUT]
