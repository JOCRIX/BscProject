...
set_property IOSTANDARD LVCMOS33 [get_ports EXT_CNV_OUT]
set_property IOSTANDARD LVCMOS33 [get_ports EXT_DCN_OUT]
set_property IOSTANDARD LVCMOS33 [get_ports EXT_EXT_CNV_ACQUIRE_EXT_ADC_CONTROL_TO_ADC_A_AND_B_OUT]
set_property IOSTANDARD LVCMOS33 [get_ports EXT_EXT_SCK_POS_ADC_CONTROL_TO_ADC_A_OUT]
set_property IOSTANDARD LVCMOS33 [get_ports EXT_EXT_SCK_POS_ADC_CONTROL_TO_ADC_B_OUT]
set_property IOSTANDARD LVCMOS33 [get_ports EXT_EXT_SDA_POS_ADC_A_TO_ADC_CONTROL_IN]
set_property IOSTANDARD LVCMOS33 [get_ports EXT_EXT_SDA_POS_ADC_B_TO_ADC_CONTROL_IN]
...
set_property OFFCHIP_TERM NONE [get_ports EXT_CNV_OUT]
set_property OFFCHIP_TERM NONE [get_ports EXT_DCN_OUT]
