...
-- Date        : Sun Nov  3 00:14:53 2024
-- Host        : DESKTOP-DNC9NIR running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file {F:/Git
--               Projects/EIT/P7---Bsc/Code/VHDL/ADCControl/ADCControl.sim/sim_1/impl/func/xsim/ADC_CONTROL_TOP_func_impl.vhd}
...
architecture STRUCTURE of adc_control is
  ...
  signal serial_clk_count0 : STD_LOGIC;
  signal \serial_clk_count[0]_i_1_n_0\ : STD_LOGIC;
  signal \serial_clk_count[3]_i_1_n_0\ : STD_LOGIC;
  signal serial_clk_count_reg : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \serial_data_adc_1[0]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[10]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[11]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[12]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[13]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[14]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[1]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[2]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[3]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[4]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[5]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[6]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[7]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[8]_i_1_n_0\ : STD_LOGIC;
  signal \serial_data_adc_1[9]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \serial_clk_count[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \serial_clk_count[2]_i_3\ : label is "soft_lutpair0";
begin
...
\serial_clk_count[2]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\serial_clk_count[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\serial_clk_count[2]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
architecture STRUCTURE of pulse_gen_width_modulator_inverted is
  ...
  signal \NLW_clk_count_reg[0]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_clk_count_reg[12]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal \NLW_pulses_generated_reg[0]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_pulses_generated_reg[12]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_pulses_generated_reg[12]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_pulses_generated_reg[4]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_pulses_generated_reg[8]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute SOFT_HLUTNM of s_toggle_i_1 : label is "soft_lutpair1";
begin
...
\clk_count_reg[0]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_clk_count_reg[0]_i_3_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
...
\clk_count_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_clk_count_reg[12]_i_1_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
...
\pulses_generated_reg[0]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_pulses_generated_reg[0]_i_3_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0001",
...
\pulses_generated_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_pulses_generated_reg[12]_i_1_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\pulses_generated_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_pulses_generated_reg[4]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\pulses_generated_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_pulses_generated_reg[8]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
architecture STRUCTURE of pulse_train_gen is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of active_i_1 : label is "soft_lutpair3";
...
architecture STRUCTURE of \pulse_train_gen__parameterized1\ is
  ...
  signal run : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \active_i_1__0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \count[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \count[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \done_i_1__0\ : label is "soft_lutpair5";
begin
...
entity ADC_CONTROL_TOP is
  ...
  attribute \DesignAttr:ENABLE_AIE_NETLIST_VIEW\ of ADC_CONTROL_TOP : entity is std.standard.true;
  attribute \DesignAttr:ENABLE_NOC_NETLIST_VIEW\ : boolean;
  attribute \DesignAttr:ENABLE_NOC_NETLIST_VIEW\ of ADC_CONTROL_TOP : entity is std.standard.true;
  attribute ECO_CHECKSUM : string;
  attribute ECO_CHECKSUM of ADC_CONTROL_TOP : entity is "f590a5bf";
end ADC_CONTROL_TOP;
