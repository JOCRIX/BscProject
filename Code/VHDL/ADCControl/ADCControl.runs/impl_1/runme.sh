...
HD_PWD='C:/EIT GIT/P7---Bsc/Code/VHDL/ADCControl/ADCControl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pulse_Width_Gen_TOP_TEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pulse_Width_Gen_TOP_TEST.tcl -notrace
