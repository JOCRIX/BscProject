...
HD_PWD='C:/EIT GIT/P7---Bsc/Code/VHDL/ADCControl/ADCControl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pulse_Width_Gen_TOP_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pulse_Width_Gen_TOP_TEST.tcl
