...
-- Date        : Sun Nov  3 21:43:20 2024
-- Host        : DESKTOP-S99FO1K running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/Users/jakob/Desktop/P7---Bsc/Code/VHDL/SingleFileSimEnvironment/SingleFileSimEnvironment.sim/sim_1/synth/func/xsim/internal_ram_func_synth.vhd
-- Design      : internal_ram
...
RAM_reg_0_15_0_0: unisim.vcomponents.RAM32X1S
    generic map(
      INIT => X"00000000"
        ...
        port map (
      A0 => ADDR_TO_IV_SAVER_OBUF(0),
      A1 => ADDR_TO_IV_SAVER_OBUF(1),
      A2 => ADDR_TO_IV_SAVER_OBUF(2),
      A3 => ADDR_TO_IV_SAVER_OBUF(3),
      A4 => '0',
      D => TORAM_IBUF(0),
...
\TOPORT[15]_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
        ...
        port map (
      I0 => ADDR_TO_IV_SAVER_OBUF(8),
      I1 => ADDR_TO_IV_SAVER_OBUF(9),
...
\TOPORT[15]_i_11\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
        ...
        port map (
      I0 => ADDR_TO_IV_SAVER_OBUF(6),
      I1 => ADDR_TO_IV_SAVER_OBUF(7),
...
\TOPORT[15]_i_14\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
        ...
        port map (
      I0 => ADDR_TO_IV_SAVER_OBUF(4),
      I1 => ADDR_TO_IV_SAVER_OBUF(5),
...
\TOPORT[15]_i_15\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
        ...
        port map (
      I0 => ADDR_TO_IV_SAVER_OBUF(2),
      I1 => ADDR_TO_IV_SAVER_OBUF(3),
...
\TOPORT[15]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
        ...
        port map (
      I0 => ADDR_TO_IV_SAVER_OBUF(14),
      I1 => ADDR_TO_IV_SAVER_OBUF(15),
...
\TOPORT[15]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
        ...
        port map (
      I0 => ADDR_TO_IV_SAVER_OBUF(12),
      I1 => ADDR_TO_IV_SAVER_OBUF(13),
...
\TOPORT[15]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
        ...
        port map (
      I0 => ADDR_TO_IV_SAVER_OBUF(10),
      I1 => ADDR_TO_IV_SAVER_OBUF(11),
...
\TOPORT_reg[15]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => ADDR_TO_IV_SAVER_OBUF(5),
      DI(0) => ADDR_TO_IV_SAVER_OBUF(3),
