...
set_property IOSTANDARD LVCMOS25 [get_ports EXT_EXT_CNV_ACQUIRE_EXT_ADC_CONTROL_TO_ADC_A_AND_B_OUT]
set_property PACKAGE_PIN J3 [get_ports EXT_EXT_SCK_POS_ADC_CONTROL_TO_ADC_A_OUT]
set_property IOSTANDARD LVCMOS25 [get_ports EXT_EXT_SCK_POS_ADC_CONTROL_TO_ADC_A_OUT]
set_property PACKAGE_PIN T3 [get_ports EXT_EXT_SCK_POS_ADC_CONTROL_TO_ADC_B_OUT]
set_property IOSTANDARD LVCMOS25 [get_ports EXT_EXT_SCK_POS_ADC_CONTROL_TO_ADC_B_OUT]
set_property PACKAGE_PIN B15 [get_ports EXT_EXT_SDA_POS_ADC_A_TO_ADC_CONTROL_IN]
set_property IOSTANDARD LVCMOS33 [get_ports EXT_EXT_SDA_POS_ADC_A_TO_ADC_CONTROL_IN]
set_property PACKAGE_PIN R3 [get_ports EXT_EXT_SDA_POS_ADC_B_TO_ADC_CONTROL_IN]
set_property IOSTANDARD LVCMOS25 [get_ports EXT_EXT_SDA_POS_ADC_B_TO_ADC_CONTROL_IN]
set_property PACKAGE_PIN A18 [get_ports EXT_TEST_ACQUIRE_START]
set_property IOSTANDARD LVCMOS33 [get_ports EXT_TEST_ACQUIRE_START]
...
set_property PACKAGE_PIN M3 [get_ports EXT_RESET_TEST]
set_property IOSTANDARD LVCMOS25 [get_ports EXT_RESET_TEST]
set_property PULLTYPE PULLDOWN [get_ports EXT_RESET_TEST]

set_property OFFCHIP_TERM NONE [get_ports EXT_EXT_CNV_ACQUIRE_EXT_ADC_CONTROL_TO_ADC_A_AND_B_OUT]
set_property OFFCHIP_TERM NONE [get_ports EXT_EXT_SCK_POS_ADC_CONTROL_TO_ADC_A_OUT]
set_property OFFCHIP_TERM NONE [get_ports EXT_EXT_SCK_POS_ADC_CONTROL_TO_ADC_B_OUT]
set_property OFFCHIP_TERM NONE [get_ports o_DATA_RDY]
...
set_property PACKAGE_PIN G17 [get_ports o_DATA_RDY]
set_property IOSTANDARD LVCMOS33 [get_ports o_DATA_RDY]
