...
HD_PWD='C:/Users/jakob/Desktop/P7---Bsc/Code/VHDL/ADCControlUpdate - AlsoFinalLmaoXD/ADCControlUpdate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_CONTROL_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_CONTROL_TOP.tcl
