...
HD_PWD='C:/Users/jakob/Desktop/P7---Bsc/Code/VHDL/ADCControlUpdate - AlsoFinalLmaoXD/ADCControlUpdate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_CONTROL_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ADC_CONTROL_TOP.tcl -notrace
