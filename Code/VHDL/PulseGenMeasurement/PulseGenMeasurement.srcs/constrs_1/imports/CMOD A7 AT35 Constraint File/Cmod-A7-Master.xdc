...
set_property DRIVE 16 [get_ports BUSY]
set_property DRIVE 16 [get_ports CLK_out]
set_property DRIVE 16 [get_ports Pulse_complete]
set_property DRIVE 16 [get_ports Pulse_out]
set_property DRIVE 16 [get_ports TRIG_out]
...
set_property PACKAGE_PIN W5 [get_ports Trig_in]
...
set_property OFFCHIP_TERM NONE [get_ports TRIG_out]
