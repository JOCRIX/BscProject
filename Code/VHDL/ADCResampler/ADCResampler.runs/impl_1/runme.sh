...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/ADCResampler/ADCResampler.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_resampler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adc_resampler.tcl -notrace
