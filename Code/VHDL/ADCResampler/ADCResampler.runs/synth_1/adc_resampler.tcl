...
read_vhdl -library xil_defaultlib {{C:/EIT GIT/P7---Bsc/Code/VHDL/ADCResampler/ADCResampler.srcs/sources_1/new/adc_resampler.vhd}}
...
synth_design -top adc_resampler -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef adc_resampler.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file adc_resampler_utilization_synth.rpt -pb adc_resampler_utilization_synth.pb"  } 
