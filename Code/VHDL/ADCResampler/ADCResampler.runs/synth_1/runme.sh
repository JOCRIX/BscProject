...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/ADCResampler/ADCResampler.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_resampler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_resampler.tcl
