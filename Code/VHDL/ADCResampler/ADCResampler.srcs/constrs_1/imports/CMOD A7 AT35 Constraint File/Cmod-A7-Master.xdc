...
set_property IOSTANDARD LVCMOS33 [get_ports o_acquire_start_adc_control]
set_property IOSTANDARD LVCMOS33 [get_ports i_reset_logic]
set_property IOSTANDARD LVCMOS33 [get_ports o_resampler_busy]
set_property IOSTANDARD LVCMOS33 [get_ports TEST_ACQ_START]
set_property IOSTANDARD LVCMOS33 [get_ports TEST_ACQ_START_OUT]
...
set_property OFFCHIP_TERM NONE [get_ports TEST_ACQ_START_OUT]
set_property OFFCHIP_TERM NONE [get_ports TEST_DDS_CLK]
set_property OFFCHIP_TERM NONE [get_ports o_acquire_start_adc_control]
set_property OFFCHIP_TERM NONE [get_ports o_resampler_busy]
set_property IOSTANDARD LVCMOS33 [get_ports TEST_DDS_CLK]
...
set_property IOSTANDARD LVCMOS33 [get_ports i_adc_control_busy]
set_property IOSTANDARD LVCMOS33 [get_ports o_acquire_start_read_int_mem]
