...
set_property IOSTANDARD LVCMOS33 [get_ports o_DDS_CLK]
set_property IOSTANDARD LVCMOS33 [get_ports o_DnB]
set_property IOSTANDARD LVCMOS33 [get_ports o_TRIG]

set_property OFFCHIP_TERM NONE [get_ports o_ADC_TRIG]
set_property OFFCHIP_TERM NONE [get_ports o_DAC_CLK]
set_property OFFCHIP_TERM NONE [get_ports o_DDS_CLK]
set_property OFFCHIP_TERM NONE [get_ports o_DnB]
set_property OFFCHIP_TERM NONE [get_ports o_TRIG]
