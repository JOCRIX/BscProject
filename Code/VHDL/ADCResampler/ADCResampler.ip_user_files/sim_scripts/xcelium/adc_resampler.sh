...
#
# Script generated by Vivado on Tue Nov 12 13:46:23 +0100 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : adc_resampler.sh
...
#
# Usage        : adc_resampler.sh
#                adc_resampler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                adc_resampler.sh [-reset_run]
#                adc_resampler.sh [-reset_log]
#                adc_resampler.sh [-help]
#
...
#                script (type 'adc_resampler.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname xbip_utils_v3_0_13 -libname axi_utils_v2_0_9 -libname xbip_pipe_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_dsp48_multadd_v3_0_9 -libname dds_compiler_v6_0_25 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 dds_compiler_v6_0_25)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "adc_resampler.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./adc_resampler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ADCResampler.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.adc_resampler xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.adc_resampler -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log adc_resampler_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./adc_resampler.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: adc_resampler.sh [-help]\n\
Usage: adc_resampler.sh [-step]\n\
Usage: adc_resampler.sh [-lib_map_path]\n\
Usage: adc_resampler.sh [-reset_run]\n\
Usage: adc_resampler.sh [-reset_log]\n\
Usage: adc_resampler.sh [-keep_index]\n\
Usage: adc_resampler.sh [-noclean_files]\n\n\
