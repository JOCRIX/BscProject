...
design_libs=(xpm xil_defaultlib xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 dds_compiler_v6_0_25)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ADCResampler.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.adc_resampler xil_defaultlib.glbl -o adc_resampler_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./adc_resampler_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key adc_resampler_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc adc_resampler_simv.daidir vcs_lib c.obj)
