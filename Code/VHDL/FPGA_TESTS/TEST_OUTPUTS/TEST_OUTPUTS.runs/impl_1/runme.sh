...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/FPGA_TESTS/TEST_OUTPUTS/TEST_OUTPUTS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_OUTPUTS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TEST_OUTPUTS.tcl -notrace
