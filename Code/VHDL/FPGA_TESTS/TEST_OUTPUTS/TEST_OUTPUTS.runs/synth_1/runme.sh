...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/FPGA_TESTS/TEST_OUTPUTS/TEST_OUTPUTS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_OUTPUTS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEST_OUTPUTS.tcl
