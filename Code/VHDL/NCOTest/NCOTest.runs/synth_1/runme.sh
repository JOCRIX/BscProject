...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/NCOTest/NCOTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nco_square_wave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nco_square_wave.tcl
