...
HD_PWD='C:/Users/jakob/Desktop/P7---Bsc/Code/VHDL/SAMPLE_CTRL_MASTTER_2.0/SAMPLE_CTRL_MASTTER_2.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MASTER_FILE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MASTER_FILE.tcl -notrace
