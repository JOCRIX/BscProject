...
HD_PWD='C:/Users/jakob/Desktop/P7---Bsc/Code/VHDL/SAMPLE_CTRL_MASTTER_2.0/SAMPLE_CTRL_MASTTER_2.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MASTER_FILE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MASTER_FILE.tcl
