...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/ExtMemTest/ExtMemTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log extmemTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source extmemTop.tcl
