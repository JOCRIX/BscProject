...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/ExtMemTest/ExtMemTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log extmemTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source extmemTop.tcl -notrace
