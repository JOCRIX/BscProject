...
HD_PWD='F:/Git Projects/EIT/P7---Bsc/Code/VHDL/ExtMemoryControl/ExtMemoryControl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ExternalMemoryDistribution.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ExternalMemoryDistribution.tcl
