...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot ADC_CONTROL_TOP xil_defaultlib.ADC_CONTROL_TOP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ADC_CONTROL_TOP -key {Behavioral:sim_1:Functional:ADC_CONTROL_TOP} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ADC_CONTROL_TOP.wdb xsim.dir libdpi.so)
