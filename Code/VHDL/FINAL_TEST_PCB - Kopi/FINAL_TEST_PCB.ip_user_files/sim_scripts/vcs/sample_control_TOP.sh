...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../FINAL_TEST_PCB.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sample_control_TOP xil_defaultlib.glbl -o sample_control_TOP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sample_control_TOP_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sample_control_TOP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sample_control_TOP_simv.daidir vcs_lib c.obj)
