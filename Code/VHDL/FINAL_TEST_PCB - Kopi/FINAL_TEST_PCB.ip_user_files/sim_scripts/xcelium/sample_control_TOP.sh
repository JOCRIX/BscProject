...
#
# Script generated by Vivado on Fri Jan 10 01:20:58 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : sample_control_TOP.sh
...
#
# Usage        : sample_control_TOP.sh
#                sample_control_TOP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sample_control_TOP.sh [-reset_run]
#                sample_control_TOP.sh [-reset_log]
#                sample_control_TOP.sh [-help]
#
...
#                script (type 'sample_control_TOP.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_13 -libname axi_utils_v2_0_9 -libname xbip_pipe_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_dsp48_multadd_v3_0_9 -libname dds_compiler_v6_0_25 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 dds_compiler_v6_0_25 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "sample_control_TOP.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sample_control_TOP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../FINAL_TEST_PCB.gen/sources_1/ip/clk_wiz_0" \
  ...
  xmvhdl -work dds_compiler_v6_0_25 -V200X $xmvhdl_opts \
  "../../ipstatic/hdl/float_pkg.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work dds_compiler_v6_0_25 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sample_control_TOP xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sample_control_TOP -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sample_control_TOP_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sample_control_TOP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sample_control_TOP.sh [-help]\n\
Usage: sample_control_TOP.sh [-step]\n\
Usage: sample_control_TOP.sh [-lib_map_path]\n\
Usage: sample_control_TOP.sh [-reset_run]\n\
Usage: sample_control_TOP.sh [-reset_log]\n\
Usage: sample_control_TOP.sh [-keep_index]\n\
Usage: sample_control_TOP.sh [-noclean_files]\n\n\
