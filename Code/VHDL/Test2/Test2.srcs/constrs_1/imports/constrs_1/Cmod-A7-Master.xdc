...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets RW_EXT_IBUF]

set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[15]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[14]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[13]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[12]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[11]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[10]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[9]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[8]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[7]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[6]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[5]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[4]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[3]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[2]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[1]}]
set_property IOSTANDARD LVTTL [get_ports {IO_PINS_EXT[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports CLK_EXT]
set_property IOSTANDARD LVCMOS33 [get_ports RW_EXT]

set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[15]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[14]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[13]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[12]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[11]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[10]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[9]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[8]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[7]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[6]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[5]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[4]}]
set_property PULLTYPE PULLDOWN [get_ports {IO_PINS_EXT[3]}]
