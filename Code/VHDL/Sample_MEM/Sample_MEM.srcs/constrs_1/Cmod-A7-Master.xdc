...
set_property PACKAGE_PIN U4 [get_ports RW_EXT]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[15]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[14]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[13]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[12]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[11]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[10]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[9]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[8]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[7]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[6]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[5]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[4]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[3]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[2]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[1]}]
set_property DRIVE 12 [get_ports {IO_PINS_EXT[0]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[15]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[14]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[13]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[12]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[11]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[10]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[9]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[8]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[7]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[6]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[5]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[4]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[3]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[2]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[1]}]
set_property SLEW FAST [get_ports {IO_PINS_EXT[0]}]

#set_property PACKAGE_PIN A17 [get_ports DUMMYOUT]
#set_property IOSTANDARD LVCMOS33 [get_ports DUMMYOUT]
...
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[15]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[14]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[13]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[12]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[11]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[10]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[9]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[8]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[7]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[6]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[5]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[4]]
set_property OFFCHIP_TERM NONE [get_ports IO_PINS_EXT[3]]
