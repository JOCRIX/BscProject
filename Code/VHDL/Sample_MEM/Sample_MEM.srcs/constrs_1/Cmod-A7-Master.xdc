...
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[15]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[14]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IO_PINS_EXT[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports CLK_EXT]
set_property IOSTANDARD LVCMOS33 [get_ports RW_EXT]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[15]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[14]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[13]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[12]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[11]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[10]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[9]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[8]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[7]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[6]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[5]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[4]}]
set_property PULLTYPE PULLUP [get_ports {IO_PINS_EXT[3]}]
...
set_property DRIVE 4 [get_ports {IO_PINS_EXT[12]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[11]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[10]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[9]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[8]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[7]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[6]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[5]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[4]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[3]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[2]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[1]}]
set_property DRIVE 4 [get_ports {IO_PINS_EXT[0]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[15]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[14]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[13]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[12]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[11]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[10]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[9]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[8]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[7]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[6]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[5]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[4]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[3]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[2]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[1]}]
set_property SLEW SLOW [get_ports {IO_PINS_EXT[0]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports TEST_RESET]
set_property PACKAGE_PIN G17 [get_ports TEST_RESET]

set_property OFFCHIP_TERM NONE [get_ports CLK_TO_IVSA]
set_property OFFCHIP_TERM NONE [get_ports TEST_RESET]
set_property OFFCHIP_TERM NONE [get_ports IVSA_ADDR[7]]
set_property OFFCHIP_TERM NONE [get_ports IVSA_ADDR[6]]
set_property OFFCHIP_TERM NONE [get_ports IVSA_ADDR[5]]
set_property OFFCHIP_TERM NONE [get_ports IVSA_ADDR[4]]
set_property OFFCHIP_TERM NONE [get_ports IVSA_ADDR[3]]
set_property OFFCHIP_TERM NONE [get_ports IVSA_ADDR[2]]
set_property OFFCHIP_TERM NONE [get_ports IVSA_ADDR[1]]
set_property OFFCHIP_TERM NONE [get_ports IVSA_ADDR[0]]
set_property PACKAGE_PIN V8 [get_ports CLK_TO_IVSA]
set_property IOSTANDARD LVCMOS33 [get_ports CLK_TO_IVSA]
...
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[15]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[14]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_DATA[0]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[15]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[14]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[13]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[12]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[11]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[10]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[9]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[8]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[7]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[6]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[5]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[4]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[3]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[2]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[1]}]
set_property PULLTYPE PULLUP [get_ports {IVSA_DATA[0]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_ADDR[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_ADDR[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_ADDR[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_ADDR[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_ADDR[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_ADDR[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_ADDR[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {IVSA_ADDR[0]}]
