...
architecture STRUCTURE of logic_reset is
  ...
  signal \reset_trig_reg__0_n_0\ : STD_LOGIC;
...
\reset_trig__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
