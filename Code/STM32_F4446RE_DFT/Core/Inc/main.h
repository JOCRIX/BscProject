...
#define UART5_TX_DISPLAY_Pin GPIO_PIN_12
#define UART5_TX_DISPLAY_GPIO_Port GPIOC
#define UART5_RX_DISPLAY_Pin GPIO_PIN_2
#define UART5_RX_DISPLAY_GPIO_Port GPIOD
